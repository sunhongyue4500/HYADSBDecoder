...
#define LOG_F_NAME  "/Users/sunhy/work/Lab/Resource/ADSB/data.log"

          /* log file for status and error
           * reports */

//#define DEF_SF_NAME  "/Users/sunhy/work/Lab/Resource/ADSB/TestData.dat"
#define DEF_SF_NAME  "/Users/sunhy/work/Lab/Resource/ADSB/save.dat"
//20091213_df17_gh.dat
...
struct Misc
{
    ...
    //the max plane num this memary can store
    int maxPlaneNum;
    //valid plane count 线程安全？
    int validPlaneCount;
    //the store space is full
    int isFull;
...
struct Plane
{
    ...
    unsigned long int urgencyAndPriority;    /* identity (squawk) (DF05 DF21) */
    ...
    double sogc;       /* speed over ground in kn ...对地速度  */
    double cogc;       /* ... course over ground 对地航向
    ...
    int sstat;       /* surveillance status (DF17)  监视状况*/
    int nicsb;       /* NIC supplement B (DF17)  单天线*/
